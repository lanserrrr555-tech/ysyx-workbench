...
void VSW2_top___024root__trace_chg_0_sub_0(VSW2_top___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VSW2_top___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSW2_top___024root__trace_chg_0\n"); );
    // Body
    ...
    VSW2_top___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void VSW2_top___024root__trace_chg_0_sub_0(VSW2_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSW2_top___024root__trace_chg_0_sub_0\n"); );
    VSW2_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void VSW2_top___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSW2_top___024root__trace_cleanup\n"); );
    // Locals
